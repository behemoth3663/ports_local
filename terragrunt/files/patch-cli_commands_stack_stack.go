--- cli/commands/stack/stack.go.orig	2025-11-10 20:41:38 UTC
...
@@ -31,36 +30,25 @@ func RunGenerate(ctx context.Context, l log.Logger, op
...
@@ -75,15 +63,12 @@ func RunOutput(ctx context.Context, l log.Logger, opts
...
@@ -154,17 +139,5 @@ func RunClean(ctx context.Context, l log.Logger, opts 
