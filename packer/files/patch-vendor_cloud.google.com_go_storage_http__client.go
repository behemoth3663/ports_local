--- vendor/cloud.google.com/go/storage/http_client.go.orig	2025-09-22 16:26:20 UTC
...
@@ -344,9 +343,6 @@ func (c *httpStorageClient) ListObjects(ctx context.Co
 	}
...
@@ -847,9 +843,6 @@ func (c *httpStorageClient) NewRangeReader(ctx context
 }
