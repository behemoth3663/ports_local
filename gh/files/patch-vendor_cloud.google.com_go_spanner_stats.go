--- vendor/cloud.google.com/go/spanner/stats.go.orig	2025-05-13 20:48:25 UTC
+++ vendor/cloud.google.com/go/spanner/stats.go
@@ -21,9 +21,6 @@ import (
 	"sync"
...
@@ -264,8 +47,7 @@ func EnableGfeLatencyView() error {
 // Deprecated: OpenCensus project is deprecated.
...
@@ -273,8 +55,7 @@ func EnableGfeHeaderMissingCountView() error {
 // Deprecated: OpenCensus project is deprecated.
...
@@ -282,11 +63,7 @@ func EnableGfeLatencyAndHeaderMissingCountViews() erro
 // Deprecated: OpenCensus project is deprecated.
...
+	return nil
 ...
 // Deprecated: OpenCensus project is deprecated.
@@ -307,46 +84,24 @@ func DisableGfeLatencyAndHeaderMissingCountViews() {
 //
 // Deprecated: OpenCensus project is deprecated. Use OpenTelemetry for capturing metrics.
...
+	_, err := strconv.Atoi(strings.TrimPrefix(serverTiming, "gfet4t7; dur="))
