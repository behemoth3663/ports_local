--- vendor/github.com/transparency-dev/tessera/client/client.go.orig	2025-09-22 08:57:07 UTC
...
@@ -102,9 +101,6 @@ func FetchCheckpoint(ctx context.Context, f Checkpoint
...
@@ -119,10 +115,6 @@ func FetchRangeNodes(ctx context.Context, s uint64, f 
...
@@ -139,11 +131,6 @@ func FetchLeafHashes(ctx context.Context, f TileFetche
...
@@ -159,10 +146,6 @@ func GetEntryBundle(ctx context.Context, f EntryBundle
...
-	span.SetAttributes(indexKey.Int64(otel.Clamp64(i)), logSizeKey.Int64(otel.Clamp64(logSize)))
 	...
 	sRaw, err := f(ctx, i, p)
@@ -199,11 +182,6 @@ func (pb *ProofBuilder) InclusionProof(ctx context.Con
...
@@ -213,10 +191,6 @@ func (pb *ProofBuilder) ConsistencyProof(ctx context.C
...
@@ -303,9 +277,6 @@ func (lst *LogStateTracker) Update(ctx context.Context
...
-
 	...
 	if err != nil {
 		return nil, nil, nil, err
@@ -385,11 +356,6 @@ func (n *nodeCache) GetNode(ctx context.Context, id co
...
-
 	...
 	if e := n.ephemeral[id]; len(e) != 0 {
 		return e, nil
@@ -399,7 +365,6 @@ func (n *nodeCache) GetNode(ctx context.Context, id co
