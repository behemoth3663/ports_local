--- internal/runner/runnerpool/controller.go.orig	2025-09-25 14:56:12 UTC
...
@@ -81,12 +80,6 @@ func (dr *Controller) Run(ctx context.Context, l log.L
...
@@ -140,7 +133,7 @@ func (dr *Controller) Run(ctx context.Context, l log.L
 						return
 					}
...
+					err := dr.runner(ctx, unit)
 					...
 					if err != nil {
@@ -161,7 +154,7 @@ func (dr *Controller) Run(ctx context.Context, l log.L
...
@@ -193,5 +186,4 @@ func (dr *Controller) Run(ctx context.Context, l log.L
 		}
