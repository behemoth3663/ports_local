--- internal/command/meta_config.go.orig	2026-09-23 11:57:56 UTC
...
@@ -282,9 +280,6 @@ func (m *Meta) installModules(ctx context.Context, roo
...
@@ -330,11 +325,6 @@ func (m *Meta) initDirFromModule(ctx context.Context, 
 // this package has a reasonable implementation for displaying notifications
 // via a provided cli.Ui.
