--- vendor/github.com/hashicorp/aws-sdk-go-base/v2/logging/http.go.orig	2023-11-28 22:50:40 UTC
...
@@ -32,145 +22,17 @@ func DecomposeHTTPRequest(ctx context.Context, req *ht
 )
...
@@ -215,10 +77,6 @@ func outgoingLength(req *http.Request) int64 {
 	return -1
 }
...
@@ -229,95 +87,9 @@ func normalizeHeaderName(k string) string {
