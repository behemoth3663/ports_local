...
@@ -29,73 +21,15 @@ func DecomposeHTTPRequest(ctx context.Context, req *ht
 )
...
@@ -112,62 +46,14 @@ type defaultRequestBodyLogger struct{}
...
@@ -212,10 +98,6 @@ func outgoingLength(req *http.Request) int64 {
 	return -1
 }
...
@@ -226,95 +108,8 @@ func normalizeHeaderName(k string) string {
