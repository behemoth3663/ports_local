...
@@ -188,41 +160,15 @@ func NewPromise[T any](ctx context.Context) (PromiseRe
...
@@ -276,10 +222,6 @@ func resolvePromiseInternalFailure(p *promise, err err
 	p.waitingMu.Lock()
...
@@ -299,7 +241,6 @@ func resolvePromiseInternalFailure(p *promise, err err
