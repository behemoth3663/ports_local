--- vendor/github.com/hashicorp/aws-sdk-go-base/v2/logging/http.go.orig	2024-10-23 22:05:39 UTC
...
@@ -32,145 +22,16 @@ func DecomposeHTTPRequest(ctx context.Context, req *ht
 )
...
@@ -215,10 +76,6 @@ func outgoingLength(req *http.Request) int64 {
 	return -1
 }
...
@@ -229,95 +86,8 @@ func normalizeHeaderName(k string) string {
