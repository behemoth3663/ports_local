--- vendor/cloud.google.com/go/spanner/metrics_monitoring_exporter.go.orig	2025-05-21 15:38:31 UTC
...
-
 func (me *monitoringExporter) stop() {
 	...
 	me.mu.Lock()
@@ -140,209 +109,7 @@ func (e *monitoringExporter) Shutdown(ctx context.Cont
 }
...
@@ -364,46 +131,4 @@ func toNonemptyTimeIntervalpb(start, end time.Time) (*
 		StartTime: startpb,
 		EndTime:   endpb,
 	}, nil
-}
