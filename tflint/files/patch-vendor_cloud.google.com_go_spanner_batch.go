--- vendor/cloud.google.com/go/spanner/batch.go.orig	2025-05-13 20:48:25 UTC
...
@@ -294,16 +277,6 @@ func (t *BatchReadOnlyTransaction) Cleanup(ctx context
...
-
 	if err != nil {
 		...
 		if sh.session != nil {
@@ -349,15 +322,6 @@ func (t *BatchReadOnlyTransaction) Execute(ctx context
 			if err != nil {
 				return client, err
 			}
...
@@ -380,16 +344,6 @@ func (t *BatchReadOnlyTransaction) Execute(ctx context
 			}, opts...)
 			if err != nil {
 				return client, err
-			}
