--- vendor/github.com/hashicorp/aws-sdk-go-base/v2/logging/http.go.orig	2026-03-20 17:11:45 UTC
...
@@ -32,73 +23,15 @@ func DecomposeHTTPRequest(ctx context.Context, req *ht
 )
...
@@ -115,62 +48,14 @@ type defaultRequestBodyLogger struct{}
...
@@ -215,10 +100,6 @@ func outgoingLength(req *http.Request) int64 {
 	return -1
 }
...
@@ -229,95 +110,8 @@ func normalizeHeaderName(k string) string {
