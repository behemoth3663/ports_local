--- vendor/cloud.google.com/go/storage/trace.go.orig	2026-08-26 17:25:54 UTC
...
+
+func contextWithTraceAttributes(ctx context.Context, attrs []any) context.Context {
+	_ = attrs
+	return ctx
+}
+
+func traceAttributesFromContext(ctx context.Context) ([]any, bool) {
+	_ = ctx
+	return nil, false
+}
+
...
@@ -66,115 +39,31 @@ func isACOEnabled() bool {
...
-	}
+func startSpanWithBucket(ctx context.Context, client *Client, bucket string, name string, opts ...any) (context.Context, any) {
+	_ = client
+	_ = bucket
 	return startSpan(ctx, name, opts...)
 }
...
-	}
-	return opts
+func getCommonTraceOptions() []any {
+	return nil
 }
